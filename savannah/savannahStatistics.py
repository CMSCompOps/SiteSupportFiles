...
for (squad,d) in sorted_squads:
    ...
    print u'%35s %10.2f \u00B1 %6.2f %5s %10.2f \u00B1 %6.2f %13i' % (squad.replace("cmscompinfrasup-",""), median_close_time_squad, error_close_time_squad, "", mean_close_time_squad, stdev_close_time_squad, len(squads[squad]['close_times']))
...
print '--------------------------------------------------------------------------------'
print u'%35s %50s %6s' % ("Squad", "Time to respond to a ticket".center(50), "Closed tickets")
print u'%35s %25s  %25s %6s' % ("", "Median".center(25), "Average".center(25), "")
...
for (squad,d) in sorted_squads:
    ...
    print u'%35s %10.2f \u00B1 %6.2f %5s %10.2f \u00B1 %6.2f %13i' % (squad.replace("cmscompinfrasup-",""), median_response_time_squad, error_response_time_squad, "", mean_response_time_squad, stdev_response_time_squad, len(squads[squad]['response_times']))
